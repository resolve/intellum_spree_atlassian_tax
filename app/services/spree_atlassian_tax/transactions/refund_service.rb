module SpreeAtlassianTax
  module Transactions
    class RefundService < SpreeAtlassianTax::Base
      def call(refundable:)
      ...
      def create_partial_refund(refundable)
        SpreeAtlassianTax::Transactions::PartialRefundService.call(
      ...
      def create_full_refund(refundable)
        SpreeAtlassianTax::Transactions::FullRefundService.call(
